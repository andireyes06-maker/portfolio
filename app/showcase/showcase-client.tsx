        ...
        >
          ...
          <div data-about-grid style={{ position: "relative", display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", gap: "clamp(32px, 5vw, 80px)", alignItems: "stretch" }}>
            {/* Portrait fills most of its column instead of sitting as a
                ...
                portrait to fill it. A larger even margin insets it well
                past edge-to-edge so it reads smaller within that same
                stretched column instead of ballooning to fill it. */}
            <div style={{ position: "relative", minHeight: 380, margin: 56 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              {/* Kanji + heading now sit directly above the paragraphs they
                  introduce, instead of above the portrait in the other
                  column. */}
